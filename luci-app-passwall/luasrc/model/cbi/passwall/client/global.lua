...
o:value("1.1.1.1", "1.1.1.1 (CloudFlare Public DNS)")
o:value("9.9.9.9", "9.9.9.9 (Quad9 DNS)")

---- DoH
o = s:taboption("DNS", Value, "up_china_dns_doh", translate("DoH request address"))
o:value("https://cloudflare-dns.com/dns-query,1.1.1.1,1.0.0.1", "CloudFlare Public DNS")
o.default = "https://cloudflare-dns.com/dns-query,1.1.1.1,1.0.0.1"
...
o:value("https://dns.quad9.net/dns-query,9.9.9.9,149.112.112.112", "Quad9")
